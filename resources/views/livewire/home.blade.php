  ...
  <main class="grid lg:grid-cols-12 gap-8 md:mt-10 ">
      ...
      <section>
        <ul class="flex overflow-x-auto scrollbar-hide items-center gap-2">
          ...
          @for ($i = 0; $i < 10; $i++) <li class="flex flex-col justify-center w-20 gap-1 p-2">
            <x-avatar wire:ignore story src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08" class="h-14 w-14" />
    ...
    <aside class="lg:col-span-4   hidden lg:block p-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <x-avatar wire:ignore src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08" class="w-12 h-12" />
        ...
        <ul class="my-2 space-y-3">
          ...
          <li class="flex items-center gap-3">
            <a  href="{{route('profile.home',$user->username)}}" >
              {{-- <x-avatar wire:ignore src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08-{{$key}}" class="w-12 h-12" /> --}}
              <x-avatar wire:ignore src="https://images.unsplash.com/photo-1554151228-14d9def656e4" class="w-12 h-12" />
            </a>
