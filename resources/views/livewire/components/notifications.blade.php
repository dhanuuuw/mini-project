        ...
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-12 gap-2 w-full">
                ...
                <a href="{{route('profile.home',$user->username)}}" class="col-span-2">
                    <x-avatar wire:ignore src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08"
                    {{-- <x-avatar wire:ignore src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08-{{rand(0,10)}}" --}}
                        class="h-10 w-10" />
                </a>
