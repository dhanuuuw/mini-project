<div wire:key="comment-{{$comment->id}}" class="flex items-center gap-3 py-2">
    {{-- <x-avatar wire:ignore   src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08-{{rand(1,10)}}" class="h-9 w-9 mb-auto" /> --}}
    <x-avatar wire:ignore   src="https://images.unsplash.com/photo-1582233479366-6d38bc390a08" class="h-9 w-9 mb-auto" />
